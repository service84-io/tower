...
namespace tower
{
class CTCodeGeneratorBoot : public dsa::vent::tower::Generator
{
public:
CTCodeGeneratorBoot()
	{
	}
	virtual ~CTCodeGeneratorBoot()
	{
	}
...
{
	static dsa::vent::tower::CTCodeGeneratorBoot g_ctcode_generator_boot;
	dsa::vent::tower::Generator::AddGenerator("DSA::Vent::Tower::CTCodeGeneratorBoot", &g_ctcode_generator_boot);
	return 0;
}
