#ifndef S84_TOWER_GENERATOR_CPPGENERATOR_CTCODE_H
#define S84_TOWER_GENERATOR_CPPGENERATOR_CTCODE_H
...
class CPPGenerator : public s84::tower::generator::ctcode::Generator {
public:
    CPPGenerator();
    inline ~CPPGenerator() {}
