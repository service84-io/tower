...
class LogToConsole(S84_Tower_Generator_ctcode.Generator):
    def __init__(self: 'LogToConsole'):
        pass

    def GenerateParser(self: 'LogToConsole',system: 'S84_Tower_System_ctcode.System',grammar: 'S84_Tower_dbnf_ctcode.Grammar',base_name: 'str') -> 'int':
